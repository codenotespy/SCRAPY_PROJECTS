...
class PartsSpider(scrapy.Spider):
    name = 'parts'
    page_number = 2
    start_urls = ['https://www.aloparca.com/oto-yedek-parca/BENTLEY']
    ...
    def parse(self, response):
        ...
        next_page = 'https://www.aloparca.com/oto-yedek-parca/BENTLEY?sayfa=' + str(PartsSpider.page_number) +'/'
        if PartsSpider.page_number < 21:
            PartsSpider.page_number +=1
            yield response.follow(next_page, callback= self.parse)
        if PartsSpider.page_number > 20:
